...
minetest.register_craft({
	output = 'hades_technic:mining_drill',
	recipe = {
		{'hades_core:tin_ingot',             'hades_technic:diamond_drill_head', 'hades_core:tin_ingot'},
		{'hades_technic:stainless_steel_ingot', 'hades_extramaterials:motor',              'hades_technic:stainless_steel_ingot'},
		{'',                              'hades_technic:red_energy_crystal', 'hades_core:copper_ingot'},
	}
})
minetest.register_craft({
	output = 'hades_technic:mining_drill_mk2',
	recipe = {
		{'hades_technic:diamond_drill_head',    'hades_technic:diamond_drill_head',   'hades_technic:diamond_drill_head'},
		{'hades_technic:stainless_steel_ingot', 'hades_technic:mining_drill',         'hades_technic:stainless_steel_ingot'},
		{'',                              'hades_technic:green_energy_crystal', ''},
	}
})
minetest.register_craft({
	output = 'hades_technic:mining_drill_mk3',
	recipe = {
		{'hades_technic:diamond_drill_head',    'hades_technic:diamond_drill_head',  'hades_technic:diamond_drill_head'},
		{'hades_technic:stainless_steel_ingot', 'hades_technic:mining_drill_mk2',    'hades_technic:stainless_steel_ingot'},
...
for i = 1, 4 do
	minetest.register_craft({
		...
		recipe = {
			{'hades_technic:diamond_drill_head',    'hades_technic:diamond_drill_head',   'hades_technic:diamond_drill_head'},
			{'hades_technic:stainless_steel_ingot', 'hades_technic:mining_drill_mk2_'..i, 'hades_technic:stainless_steel_ingot'},
			{'',                              'hades_technic:blue_energy_crystal',  ''},
		}
	})
end
...
local function drill_dig_it0 (pos,player)
	...
	if node.name == "hades_core:lava_source" then return end
	if node.name == "hades_core:lava_flowing" then return end
	if node.name == "hades_core:water_source" then minetest.remove_node(pos) return end
	if node.name == "hades_core:water_flowing" then minetest.remove_node(pos) return end
...
local function mining_drill_mk2_setmode(user,itemstack)
    ...
    itemstack:set_name("hades_technic:mining_drill_mk2_"..mode);
	meta["mode"]=mode
...
local function mining_drill_mk3_setmode(user,itemstack)
    ...
    itemstack:set_name("hades_technic:mining_drill_mk3_"..mode);
	meta["mode"]=mode
    itemstack:set_metadata(minetest.serialize(meta))
	return itemstack
end
...
technic.register_power_tool("hades_technic:mining_drill", max_charge[1])

minetest.register_tool("hades_technic:mining_drill", {
...
minetest.register_tool("hades_technic:mining_drill_mk2", {
...
technic.register_power_tool("hades_technic:mining_drill_mk2", max_charge[2])

for i = 1, 4 do
	technic.register_power_tool("hades_technic:mining_drill_mk2_"..i, max_charge[2])
	minetest.register_tool("hades_technic:mining_drill_mk2_"..i, {
...
minetest.register_tool("hades_technic:mining_drill_mk3", {
...
technic.register_power_tool("hades_technic:mining_drill_mk3", max_charge[3])

for i=1,5,1 do
	technic.register_power_tool("hades_technic:mining_drill_mk3_"..i, max_charge[3])
	minetest.register_tool("hades_technic:mining_drill_mk3_"..i, {
